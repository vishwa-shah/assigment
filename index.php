								...
								foreach ( $albums['data'] as $album ) {
									...
									if ( !empty( $album_photos ) ) {
										foreach ( $album_photos['data'] as $album_photo ) {
											...
											//echo '<pre>';print_r($album_photo);exit;
											if ( $album['cover_photo']->id == $album_photo['id'] ) {
												$album_cover_photo = $album_photo['source'];
												$album_resized_cover_photo = 'libs/resources/albums/covers/'.$album['cover_photo']->id.'_350X420.jpg';
